...
from fightmetric.scraper import (scrape_links,
                         scrape_event_data,
                         scrape_fight_data,
                         scrape_fighter_data,
                         combine_data)
...
def test_event_scraping(sample_event):
    ...
    pprint(event)
    assert event == {'event': 'UFC 214: Cormier vs. Jones 2',
                     'date': date(2017, 7, 29),
...
def test_fight_scraping(sample_fight):
    ...
    assert fight == [{'bonus': {
                      ...
                      'result': 'Win',
                      'round': 5.0,
                      'stats': {'body': {'avoided': 1.0, 'landed': 13.0, 'received': 2.0, 'thrown': 18.0},
                                'clinch': {'avoided': 0.0, 'landed': 1.0, 'received': 2.0, 'thrown': 1.0},
                                'distance': {'avoided': 61.0, 'landed': 56.0, 'received': 26.0, 'thrown': 152.0},
                                'ground': {'avoided': 0.0, 'landed': 0.0, 'received': 0.0, 'thrown': 0.0},
                                'head': {'avoided': 60.0, 'landed': 40.0, 'received': 23.0, 'thrown': 131.0},
                                'knockouts': {'avoided': 0.0, 'landed': 0.0, 'received': 0.0, 'thrown': 1.0},
                                'leg': {'avoided': 0.0, 'landed': 4.0, 'received': 3.0, 'thrown': 4.0},
                                'sig. str': {'avoided': 61.0, 'landed': 57.0, 'received': 28.0, 'thrown': 153.0},
                                'submissions': {'avoided': 0.0, 'landed': 0.0, 'received': 0.0, 'thrown': 0.0},
                                'td': {'avoided': 21.0, 'landed': 0.0, 'received': 0.0, 'thrown': 0.0},
                                'total str.': {'avoided': 61.0, 'landed': 57.0, 'received': 29.0, 'thrown': 153.0}},
                      'time': 5.0,
                     ...
                     {'bonus': {'fight': False,
                      ...
                      'result': 'Loss',
                      'round': 5.0,
                      'stats': {'body': {'avoided': 5.0, 'landed': 2.0, 'received': 13.0, 'thrown': 3.0},
                                'clinch': {'avoided': 0.0, 'landed': 2.0, 'received': 1.0, 'thrown': 2.0},
                                'distance': {'avoided': 96.0, 'landed': 26.0, 'received': 56.0, 'thrown': 87.0},
                                'ground': {'avoided': 0.0, 'landed': 0.0, 'received': 0.0, 'thrown': 0.0},
                                'head': {'avoided': 91.0, 'landed': 23.0, 'received': 40.0, 'thrown': 83.0},
                                'knockouts': {'avoided': 1.0, 'landed': 0.0, 'received': 0.0, 'thrown': 0.0},
                                'leg': {'avoided': 0.0, 'landed': 3.0, 'received': 4.0, 'thrown': 3.0},
                                'sig. str': {'avoided': 96.0, 'landed': 28.0, 'received': 57.0, 'thrown': 89.0},
                                'submissions': {'avoided': 0.0, 'landed': 0.0, 'received': 0.0, 'thrown': 0.0},
                                'td': {'avoided': 0.0, 'landed': 0.0, 'received': 0.0, 'thrown': 21.0},
                                'total str.': {'avoided': 96.0, 'landed': 29.0, 'received': 57.0, 'thrown': 90.0}},
                      'time': 5.0,
                      'time format': (10, 5, 5, 5, 5),
                      'titlefight': True}]
...
def test_fighter_scraping(sample_fighter):
    ...
    from pprint import pprint
    pprint(fighter)
    assert fighter == [{'name': 'Demian Maia',
                       'height': 6.1,
                       'reach': 72.0,
                       'weight': 170.0,
                       'stance': 'Southpaw',
...
def test_combine_data(sample_event, sample_fighter, sample_opponent, sample_fight):
    ...
    fights = {data['name']: data for data in scrape_fight_data(sample_fight, 'sample_link', 1)}
    event = scrape_event_data(sample_event)
    data = combine_data(event, fights, fighters)
    from pprint import pprint
    pprint(data)
    assert data == [{ 'attendance': 16610.0,
                      'birth': date(1982, 4, 7),
                      'bonus': {'fight': False,
                                'ko': False,
                                'performance': False,
